...
echo "CREATE USER 'powermail'@'localhost' IDENTIFIED BY '$MYSQLPASSVPOP';" | mysql -uroot
echo "GRANT ALL PRIVILEGES ON *.* TO 'powermail'@'localhost' WITH GRANT OPTION;" | mysql -uroot
